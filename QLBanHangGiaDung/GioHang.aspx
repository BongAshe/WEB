<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="GioHang.aspx.cs" Inherits="QLBanHangGiaDung.GioHang" %>
                        ...
                        <div class='chitietdondathang box '>
                            <div class='row'>
                                ...
                                <div class='col-xs-12 col-sm-6 col-md-2 col-lg-2'>
                                    <h4 style='color: orange;'><%# String.Format("{0}",Convert.ToInt32(Eval("iPrice")) * (100-Convert.ToInt32(Eval("fPromotion")))/100)%> vnd</h4>
                                ...
                                <div class='col-xs-12 col-sm-6 col-md-3 col-lg-3'>
                                    ...
                                    <%--<input type="checkbox" class="form-control" onclick="checkProduct('<%# Eval("PK_iCartID") %>',this.checked)" <%# (bool)Eval("bCheck") ? "checked" : ""%> />--%>
                                </div>
                            </div>
                        </div>
                    </ItemTemplate>
