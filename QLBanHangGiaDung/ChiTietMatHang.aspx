<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ChiTietMatHang.aspx.cs" Inherits="QLBanHangGiaDung.ChiTietMatHang" %>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <p>
                    Đơn giá: <asp:Label ID="dongia" runat="server"></asp:Label>
            ...
            xhttp.onreadystatechange = function () {
                if (this.readyState == 4 && this.status == 200) {
                    if (this.responseText == "success") {
                        ...
                        //alert("Thêm giỏ hàng thàng công ok");
