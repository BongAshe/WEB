<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DanhSachSanPham.aspx.cs" Inherits="QLBanHangGiaDung.DanhSachSanPham" %>
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="input-group">
                   <%-- Tìm Kiếm SP <input type="text" id="keysearch" runat="server" class="form-control" placeholder="Tìm kiếm...">
                ...
                <asp:Repeater ID="rpDanhMucSP" runat="server">
                    ...
                    <ItemTemplate>
                        ...
                        <li class="alert-info">
                            <a href="DanhSachSanPham.aspx?maloai=<%# Eval("PK_iType") %>"><%# Eval("sTypeName") %></a>
                        </li>
                    </ItemTemplate>
                    <FooterTemplate>
                        </ul>
