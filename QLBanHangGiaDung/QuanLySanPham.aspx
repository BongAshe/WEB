<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="QuanLySanPham.aspx.cs" Inherits="QLBanHangGiaDung.QuanLySanPham" %>
                    ...
                    <center>
						...
						<div class="form-group row">
							<div class="col-sm-12 ">									
								...
								<br>
								<center> 
                                    <button type="submit" runat="server" class="btn btn-basic" ID="buttonCancel" onserverClick="btnCancel_Click">Hủy</button>
								</center>
							</div>
