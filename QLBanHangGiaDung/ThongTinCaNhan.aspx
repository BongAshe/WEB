<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ThongTinCaNhan.aspx.cs" Inherits="QLBanHangGiaDung.ThongTinCaNhan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-2">
                <img src="images/img_avatar.png" alt="avatar" width="100%" />
                <hr />
