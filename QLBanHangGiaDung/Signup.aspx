<%@ Page Title="" Language="C#" MasterPageFile="~/Login.Master" AutoEventWireup="true" CodeBehind="Signup.aspx.cs" Inherits="QLBanHangGiaDung.Signup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div id="formContent">
    <!-- Login Form -->
      <center><h3>Đăng ký thông tin</h3></center>
    ...
    ValidationExpression="^[^\d]+$" />--%>
      ...
      <input type="text" id="username" class="form-control" placeholder="Tên đăng nhập" runat="server">
        <asp:RequiredFieldValidator ID="rqTenDangNhap" runat="server" ErrorMessage="Vui lòng nhập tên đăng nhập" ControlToValidate="phonenumber"></asp:RequiredFieldValidator>
